function [] = backgroundMakerAllforPractice(part_num)

addpath('C:\Users\stweis\Documents\GitHub\Arrows_FMRI');
cd('C:\Users\stweis\SkyDrive\MVPA_ARROWS\FMRI_Materials\Behavioral_Exp v03\Practice_Stims\schemas_words\');
files = dir('*png*');
temp = struct2cell(files);
names = temp(1,:)';

%To randomly assign backgrounds
cd('C:\Users\stweis\SkyDrive\MVPA_ARROWS\FMRI_Materials\Behavioral_Exp v03\Practice_Stims\png_imgs\scrambled\');
files_b = dir('*jpg*');
...
for i=1:length(names)
    ...
    backgroundMakerforPractice('C:\Users\stweis\SkyDrive\MVPA_ARROWS\FMRI_Materials\Behavioral_Exp v03\Practice_Stims\schemas_words',name,name_b);
end
